...
type Cfg struct {
	...
	EnableCompress bool   `env:"LOG_ENABLE_COMPRESS"  flag-long:"log-enable-compress"  yaml:"enableCompress"  flag-description:"enable compress using gzip after log rotate"`
}

...
func init() {
	plugin.Reg(ReaderOSS, func() Reader { return NewOSSReader() }, func() any { return NewOSSCfg() })
	plugin.Reg(WriterOSS, func() Writer { return NewOSSWriter() }, func() any { return NewOSSCfg() })
}

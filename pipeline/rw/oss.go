...
func (o *OSS) Init() error {
	...
	if o.IsReader() {
		...
		if o.OSSCfg.Append {
			o.NestWriter(createOSSAppendWriter(o.Ctx(), o.OSSCfg))
		} else {
...
func createOSSAppendWriter(ctx context.Context, ossCfg *OSSCfg) *oss.AppendWriter {
	w := oss.NewAppendWriter(ctx, createOSSCfg(ossCfg))
	return w
}
